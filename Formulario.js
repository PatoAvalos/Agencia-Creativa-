...
let servicio=prompt("¿Que servicio de diseño requieres?: Identidad,  Publicitario, Editorial, y Diseño Web");
...
switch (servicio){
  case "IDENTIDAD":
    serviciosElegidos.push(new servicioElegido(
  ...
  case "DISEÑO WEB":
      serviciosElegidos.push(new servicioElegido(
       "Sitio Web Informativo o Landing Page", 
       7500 ));
      break;
  default:
    console.log("Si el servicio que requiere necesita ser más especifico a tu necesidad, ponte en contacto con nosotros");
}
